      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-transparent
            group-data-[variant=floating]:rounded-none group-data-[variant=floating]:shadow-cubist
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className="shadow-cubist-icon" />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        `relative flex w-full flex-1 flex-col bg-transparent md:peer-data-[variant=inset]:m-2
        md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-none
        md:peer-data-[variant=inset]:shadow-cubist
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-4 p-2 my-2", className)}
      {...props}
    />
  )
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        `flex h-8 shrink-0 items-center rounded-none px-2 text-xs font-medium
        text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity]
        duration-200 ease-linear group-data-[collapsible=icon]:-mt-8
        group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4
        [&>svg]:shrink-0`,
        className
      )}
      {...props}
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        `absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-none
        ...
        hover:text-sidebar-accent-foreground focus-visible:ring-2 md:after:hidden [&>svg]:size-4
        [&>svg]:shrink-0`,
        className
      )}
      {...props}
...
const sidebarMenuButtonVariants = cva(
  `peer/menu-button group/menu-button flex w-full items-center gap-4 overflow-visible rounded-none
  p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding]
  ...
  data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0
  [&>span:last-child]:truncate shadow-cubist`,
  {
    variants: {
      variant: {
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        `absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-none
        p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform
  ...
  return (
    <div
      ...
      className={cn(
        ...
        rounded-none px-1 text-xs font-medium text-sidebar-foreground tabular-nums select-none
        group-data-[collapsible=icon]:hidden peer-hover/menu-button:text-sidebar-accent-foreground
        peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn("flex h-8 items-center gap-4 rounded-none px-2", className)}
      {...props}
    >
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        `mx-3.5 flex min-w-0 translate-x-px flex-col gap-4 border-l border-sidebar-border px-2.5
        py-3.5 group-data-[collapsible=icon]:hidden`,
        className
      )}
      {...props}
    />
...
function SidebarMenuSubItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-sub-item relative shadow-cubist", className)}
      {...props}
    />
  )
}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        `flex h-7 min-w-0 -translate-x-px items-center gap-4 overflow-hidden rounded-none px-2
        ...
        aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[size=md]:text-sm
        data-[size=sm]:text-xs data-active:bg-sidebar-accent
