...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        `group/card flex flex-col gap-(--card-spacing) overflow-visible rounded-none bg-card
        py-(--card-spacing) text-sm text-card-foreground shadow-cubist ring-1 ring-foreground/10
