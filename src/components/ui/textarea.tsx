...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        `flex field-sizing-content min-h-16 w-full rounded-none border border-input bg-background
        px-2.5 py-2 text-base shadow-cubist transition-colors outline-none
